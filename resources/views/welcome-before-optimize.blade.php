...
@section('container')
    ...
    <div class="container-fluid px-0">
        ...
        {{-- ================= HEAVY DECORATIVE SECTION ================= --}}
        <div style="display: none;" aria-hidden="true">
            <!-- Heavy decorative images untuk memperlambat loading -->
            <img src="https://placehold.co/1920x1080/4f46e5/ffffff?text=Loading+1" alt="">
            <img src="https://placehold.co/1920x1080/4338ca/ffffff?text=Loading+2" alt="">
            <img src="https://placehold.co/1920x1080/312e81/ffffff?text=Loading+3" alt="">
            <img src="https://placehold.co/1920x1080/1e1b4b/ffffff?text=Loading+4" alt="">
            <img src="https://placehold.co/1920x1080/0f172a/ffffff?text=Loading+5" alt="">
        </div>
    ...
    {{-- ================= HEAVY INLINE STYLES ================= --}}
    <style>
        /* wrapper tanpa aspect ratio (berat) */
        .mitra-image-wrapper {
            position: relative;
            width: 100%;
            height: 180px;
        ...
        /* image tanpa lazy loading class */
        .mitra-cover {
            width: 100%;
            height: 100%;
            object-fit: cover;
    ...
    {{-- ================= TANPA INTERSECTION OBSERVER (LAZY LOADING DIHAPUS) ================= --}}
    ...
    {{-- ================= HEAVY BLOCKING SCRIPT ================= --}}
    <script>
        // Simulasi proses berat yang memblokir rendering
        console.log('Memulai proses berat...');
        const startTime = performance.now();

        // Loop berat untuk memperlambat JavaScript execution
        let heavyResult = 0;
        ...
        console.log('Proses berat selesai dalam ' + (endTime - startTime).toFixed(2) + 'ms');
        console.log('Hasil: ' + heavyResult);
    </script>

    {{-- ================= TAMBAHAN GAMBAR BESAR UNTUK MEMPERBERAT ================= --}}
    <img src="https://placehold.co/3000x2000/4f46e5/ffffff?text=Heavy+Background+1" style="display:none;" alt=""
        aria-hidden="true">
    <img src="https://placehold.co/3000x2000/4338ca/ffffff?text=Heavy+Background+2" style="display:none;" alt=""
        aria-hidden="true">
    <img src="https://placehold.co/3000x2000/312e81/ffffff?text=Heavy+Background+3" style="display:none;" alt=""
        aria-hidden="true">
