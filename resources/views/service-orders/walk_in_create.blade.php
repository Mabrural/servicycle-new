                    ...
                    <div class="card card-rounded">
                        <div class="card-body">
                            ...
                            <form action="{{ route('service-orders.walk_in.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <textarea name="customer_complain" rows="4" class="form-control" placeholder="Keluhan customer...">{{ old('customer_complain') }}</textarea>
                                </div>

                                <div class="text-end">
                                    <a href="{{ route('service-orders.index') }}" class="btn btn-light">Batal</a>
