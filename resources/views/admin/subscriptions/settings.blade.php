            ...
            <div class="col-12 col-xl-12">
                <div class="home-tab">
                    ...
                    <div class="mb-4 border-bottom pb-2">
                        <h4 class="fw-bold mb-1">Pengaturan Subscription Pro</h4>
                        <p class="text-muted mb-0">
                            Kelola fitur premium untuk Customer & Mitra
                        </p>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.subscription.settings.update') }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 p-3 border rounded">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input
                                            ...
                                            name="mitra_price"
                                            class="form-control"
                                            value="{{ old('mitra_price', $setting->mitra_price) }}"
                                            min="0"
                                        >
                                    </div>
